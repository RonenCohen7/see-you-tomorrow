...
const defaultHelp: HelpSegment[] = [
  {
    text: "ברוכים הבאים. כאן תמצאו הסבר קצר על המסך הנוכחי ומה אפשר לעשות בו. אפשר להפעיל או להשתיק את הקריינות בכל רגע.",
  },
];
...
const scripts: Record<string, HelpSegment[]> = {
  ...
  "/calendar": [
    { text: "בלשונית «שבעה ימים קרובים» מוצגים שבעת הימים בשלוש שורות (שלושה בעמודה), כדי לפנות מקום לתוכן בלי לצמצם את גודל הכרטיסים." },
  ...
  "/schedules": [
    ...
    { text: "לחיצה כפולה על שורת שיבוץ פותחת את דף הדוחות עם אותו עובד, תאריך וסטטוס. זה שימושי להפקת קובץ PDF או לשליחה במייל." },
  ],
  "/parking": [
